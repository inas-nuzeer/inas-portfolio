...
<head>
    <title>Inas Nuzeer - Portfolio</title>
    <meta charset="utf-8">
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target"
        id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" href="index.html">Inas Nuzeer<span>.</span></a>
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav nav ml-auto">
                    ...
                    <li class="nav-item"><a href="#blog-section" class="nav-link"><span>Acheivements</span></a></li>
                ...
                <div class="container-fluid px-md-0">
                    <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end"
                        ...
                        <div class="one-forth d-flex  align-items-center ftco-animate"
                            ...
                            <div class="text">
                                <span class="subheading">Hello! This is Inas Nuzeer</span>
                                <h1 class="mb-4 mt-3">Creative <span>Full Stack</span> Developer</h1>
                                <p><a href="#" class="btn btn-primary">Hire me</a> <a href="images/Inas Nuzeer's CV.pdf"
                                        download="" class="btn btn-primary btn-outline-primary">Download CV</a></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container-fluid px-md-0">
                    <div class="row d-flex no-gutters slider-text align-items-end justify-content-end"
                        ...
                        <div class="one-forth d-flex align-items-center ftco-animate"
                            data-scrollax=" properties: { translateY: '70%' }">
                            <div class="text">
                                <span class="subheading">We Design &amp; Develop Brands</span>
                                <h1 class="mb-4 mt-3">Hi, I am <span>Inas Nuzeer</span></h1>
                    ...
                    <div class="py-md-5">
                        <div class="row justify-content-start pb-3">
                            <div class="col-md-12 heading-section ftco-animate">
                                ...
                                <p>A highly motivated individual seeking dynamic organization to contribute, learn, and
                                    grow in a collaborative and innovative environment. Dedicated to gaining practical
                                    experience, expanding skills, and making a positive impact while enhancing
                                    professional growth.</p>

                                <ul class="about-info mt-4 px-md-0 px-2">
                                    <li class="d-flex"><span>Name:</span> <span>Inas Nuzeer</span></li>
                                    <li class="d-flex"><span>Date of birth:</span> <span>September 19, 1999</span></li>
                                    <li class="d-flex"><span>Address:</span> <span>Mawanella, Sri Lanka</span></li>
                                    <!-- <li class="d-flex"><span>Zip code:</span> <span>1000</span></li> -->
                                    <li class="d-flex"><span>Email:</span> <span>inasnuzeer@gmail.com</span></li>
                                    <li class="d-flex"><span>Phone: </span> <span>+94 76 418 9477</span></li>
                                </ul>
                            </div>
                            <!-- <div class="col-md-12">
            ...
            <div class="row progress-circle mb-5">
                <div class="col-lg-4 mb-4">
                    <div class="bg-white rounded-lg shadow p-4">
                        <h2 class="h5 font-weight-bold text-center mb-4">Dart - Flutter</h2>
                ...
                <div class="col-lg-4 mb-4">
                    <div class="bg-white rounded-lg shadow p-4">
                        <h2 class="h5 font-weight-bold text-center mb-4">Firebase</h2>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="media block-6 services d-block bg-white rounded-lg shadow ftco-animate">
                        ...
                        <div class="media-body">
                            <h3 class="heading mb-3">Desktop Applications</h3>
                            <p>A small river named Duden flows by their place and supplies.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-md-4 col-lg-4 d-flex align-items-end">
                    <img src="images/author-2.png" class="img-fluid" alt="">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="project img shadow ftco-animate d-flex justify-content-center align-items-center"
                        ...
                        <div class="text text-center p-4">
                            <h3><a href="#">Xplorit - Rent with ease </a></h3>
                ...
                <div class="col-md-3">
                    <div class="project img shadow ftco-animate d-flex justify-content-center align-items-center"
                        ...
                        <div class="overlay"></div>
                        <div class="text text-center p-4">
                            <h3><a href="#">Restaurant - Table Booking</a></h3>
                ...
                <div class="col-md-3">
                    <div class="project img shadow ftco-animate d-flex justify-content-center align-items-center"
                        ...
                        <div class="overlay"></div>
                        <div class="text text-center p-4">
                            <h3><a href="#">Iterative Math Solver</a></h3>
                            <span>Desktop Application</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="project img shadow ftco-animate d-flex justify-content-center align-items-center"
                        ...
                        <div class="overlay"></div>
                        <div class="text text-center p-4">
                            <h3><a href="#">Fishing Fleet Management</a></h3>
                            <span>Desktop Application</span>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center mb-5 pb-5">
                <div class="col-md-7 heading-section text-center ftco-animate">
                    <span class="subheading">Acheivements</span>
                    <h2 class="mb-4">Acheivements</h2>
                    <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
                </div>
            </div>
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-md-6 d-flex ftco-animate">
                    <div class="blog-entry">
                        <a href="single.html" class="block-20" style="background-image: url('images/certificate.jpg');">
                        </a>
                        <div class="text mt-3 float-right d-block">
                            <div class="d-flex align-items-center mb-3 meta">
                                <p class="mb-0">
                                    <span class="mr-2">June 17, 2024</span>
                                    <a href="#" class="mr-2">Xplorit</a>
                                    <a href="#" class="meta-chat"><span class="icon-chat"></span> - Rent With Ease</a>
                                </p>
                            </div>
                            <h3 class="heading"><a href="single.html">Secured 3rd place in the Final Year Project
                                    Display</a></h3>
                ...
                <div class="col-md-8">
                    ...
                    <form action="#" method="POST" class="bg-light p-4 p-md-5 contact-form">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <textarea name="" id="" name="message" cols="30" rows="7" class="form-control"
                ...
                <div class="col-md-4 d-flex pl-md-5">
                    <div class="row">
                        <div class="dbox w-100 d-flex">
                            ...
                            <div class="text">
                                <p><span>Address:</span> Mawanella, Sri Lanka</p>
                            </div>
                        </div>
                        <div class="dbox w-100 d-flex">
                            <div class="icon d-flex align-items-center justify-content-center">
                            ...
                            <div class="text">
                                <p><span>Phone:</span> <a href="tel:+94 76 418 9477">+94 76 418 9477</a></p>
                            </div>
                        </div>
                        <div class="dbox w-100 d-flex">
                            <div class="icon d-flex align-items-center justify-content-center">
                            ...
                            <div class="text">
                                <p><span>Email:</span> <a href="mailto:inasnuzeer@gmail.com">inasnuzeer@gmail.com</a>
                                </p>
                            </div>
                        </div>
                        <div class="dbox w-100 d-flex">
                ...
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a href="#"><span class="fa fa-chevron-right mr-2"></span>Desktop Application</a></li>
                ...
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <div class="block-23 mb-3">
                            <ul>
                                <li><span class="icon fa fa-map marker"></span><span class="text">Mawanella, Sri Lanka</span></li>
                                <li><a href="tel:+94 76 418 9477"><span class="icon fa fa-phone"></span><span class="text">+94 76 418 9477</span></a></li>
                                <li><a href="mailto:inasnuzeer@gmail.com"><span class="icon fa fa-paper-plane pr-4"></span><span class="text">inasnuzeer@gmail.com</span></a></li>
                            </ul>
                        </div>
